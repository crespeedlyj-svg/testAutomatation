...
// 생성일시: 2026-06-29  |  파일: 20260629_pur_inte.spec.ts
// 생성자: SYSTEM
// ==============================================================
...
let savedRecordKey = '';  // INSERT TC → DELETE TC 키 전달
...
test.describe('통합 테스트 - PUR_0910M (PUR_0910M)', () => {
  ...
  // ────────────────────────────────────────────────────────────────────────────
  // TC003: PUR_0910M 화면 로드 확인
  //   sharedFrame 에서 핵심 컴포넌트 존재 여부로 로드 상태 재확인
  // ────────────────────────────────────────────────────────────────────────────
  test('TC003: PUR_0910M 화면 로드 확인', async ({ workerPage: page }) => {
    logTestStart('TC003: PUR_0910M 화면 로드 확인');
