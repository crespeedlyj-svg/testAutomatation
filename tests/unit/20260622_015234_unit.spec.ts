// ==============================================================
// PUR — 직접구매지급신청 단위 테스트
// 생성일시: 2026-06-22  |  파일: 20260622_015234_unit.spec.ts
// 생성자: 관리자
...
test.describe('직접구매지급신청 단위 테스트', () => {
  ...
  /**
   * [no:1] [단위] [SELECT] pur_0910M - 조회 (버튼 클릭)
   * URL: /mis/pur/pur0910/getList.do
   * 예상결과: HTTP 200, ds_list Dataset 1건 이상 반환
   */
  test('[no:1] [단위] [SELECT] pur_0910M - 조회 (버튼 클릭)', async ({ workerPage: page }) => {
    logTestStart('[no:1] [단위] pur_0910M - 조회 (버튼 클릭)');
